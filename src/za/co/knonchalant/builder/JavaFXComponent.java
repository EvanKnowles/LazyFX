...
public class JavaFXComponent {
     ...
     * @return the GUI
     */
    public static Pane build(Object object, Window window) {
        return build(object, false, window);
    }
     ...
     * @return the GUI
     */
    public static Pane build(Object object, TaggedParameters parameters, Window window) {
        return build(object, false, Layout.VERTICAL, parameters, window);
    }
     ...
     * @return the GUI
     */
    public static Pane build(Object object, boolean readOnly, Window window) {
        return build(object, readOnly, Layout.VERTICAL, null, window);
    }
     ...
     * @return the GUI
     */
    public static Pane build(Object object, Layout layout, Window window) {
        return build(object, false, layout, null, window);
    }
     ...
     * @return the GUI
     */
    public static Pane build(Object object, boolean readOnly, Layout layout, Window window) {
        return build(object, readOnly, layout, null, window);
    }
     ...
     * @return the GUI
     */
    public static Node build(Object object, Layout layout, TaggedParameters taggedParameters, Window window) {
        return build(object, false, layout, taggedParameters, window);
    }
     ...
     * @return the GUI
     */
    public static Pane build(Object object, boolean readOnly, Layout layout, TaggedParameters params, Window window) {
        ...
        for (Method method : declaredMethods) {
            ...
            HBox methodBox = produceFieldNode(object, readOnly, params, method, window);
     ...
     */
    private static HBox produceFieldNode(Object object, boolean readOnly, TaggedParameters params, Method method, Window window) {
        ...
        if (validGetterMethod(method)) {
            ...
            Node valueNode = getValueField(object, method, readOnly || getSetter(method) == null, name, params, window);
     ...
     */
    private static Node getValueField(Object object, Method method, boolean readOnly, String name, TaggedParameters params, Window window) {
        if (params == null) {
        ...
        Node returned = converter.convert(result, readOnly, params, window);
